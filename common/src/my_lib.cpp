...
//int graph_laplacian_norm(torch::Tensor *indices, torch::Tensor *values, torch::Tensor *norm)
...
//int graph_degree_norm(torch::Tensor *indices, torch::Tensor *values, torch::Tensor *norm)
